...
args="-S $I_INSTANCE --home ${SITL_LOCATION} --model ${TRI} --speedup 1 --serial4=sim:lightwareserial --defaults ${SITL_PARAMETER_LIST},${IDENTITY_FILE},${SUREFLITE_PARAMS} ${SITL_MCAST}"
